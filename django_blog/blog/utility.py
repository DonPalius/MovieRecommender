...
def pearson_correlation(ratings_A: pd.DataFrame, ratings_B: pd.DataFrame):
    ''' calculates similarity measure using Pearson correlation
...
def transform_overview(overview: str) -> str:
    ...
    overview = re.sub('[!@?#$%^&*()"<>/\`~+=-_.,`“‘:;]', '',
                      overview)  # deleting special characters
    return overview
...
def normalization(title: str) -> str:
    ...
    transform6 = re.sub(r'((((X{0,3})(IX|IV|V?I{0,3}))|[V|X]((I{0,3})(IX|IV|V?I{0,3})))+\s*)?:.*', '', transform5)
    transform7 = re.sub(r'(((X{0,3})(IX|IV|V?I{0,3}))|[V|X]((I{0,3})(IX|IV|V?I{0,3})))+\s*', '', transform6)
    transform8 = re.sub(r'((((X{0,3})(IX|IV|V?I{0,3}))|[V|X]((I{0,3})(IX|IV|V?I{0,3})))+\s*)?\(.*\)', '', transform7)
